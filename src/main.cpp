...
void opcontrol() {
	...
	MotorGroup left_mg({-1, 2, -3, 4});    // Creates a motor group with forwards ports 1 & 3 and reversed port 2
	MotorGroup right_mg({6, -7, 8, -9});  // Creates a motor group with forwards port 5 and reversed ports 4 & 6
